...
CONSTRAINT `FK_20` FOREIGN KEY `FK_22` (`channelName`) REFERENCES `Channel` (`channelName`)  ON UPDATE CASCADE ,
KEY `FK_33` (`username`),
...
CONSTRAINT `FK_28` FOREIGN KEY `FK_30` (`channelName`) REFERENCES `Channel` (`channelName`) ON UPDATE CASCADE ,
KEY `FK_37` (`username`),
...
(
    ...
    CONSTRAINT `FK_41` FOREIGN KEY `FK_40` (`channelName`) REFERENCES `Channel` (`channelName`)  ON UPDATE CASCADE ,
    KEY `FK_50` (`username`),
